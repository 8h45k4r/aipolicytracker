...
return [
    ...
    'paths' => [
        ...
        '/incidents' => ['get' => ['summary' => 'Incidents mirrored from the AI Incident Database', 'operationId' => 'listIncidents', 'description' => 'Responses carry the upstream source, licence and citation in meta.source; reusing the rows carries that attribution requirement with them.', 'parameters' => [['name' => 'domain', 'in' => 'query', 'schema' => ['type' => 'string']], ['name' => 'country', 'in' => 'query', 'schema' => ['type' => 'string']], ['name' => 'from', 'in' => 'query', 'schema' => ['type' => 'string', 'format' => 'date']], ['name' => 'per_page', 'in' => 'query', 'schema' => ['type' => 'integer']], ['name' => 'page', 'in' => 'query', 'schema' => ['type' => 'integer']]], 'responses' => ['200' => ['description' => 'Paginated incidents with source attribution']]]],
        '/risks' => ['get' => ['summary' => 'Risk entries mirrored from the MIT AI Risk Repository', 'operationId' => 'listRisks', 'description' => 'Responses carry the upstream source, licence and citation in meta.source; reusing the rows carries that attribution requirement with them.', 'parameters' => [['name' => 'domain', 'in' => 'query', 'schema' => ['type' => 'integer']], ['name' => 'entity', 'in' => 'query', 'schema' => ['type' => 'string']], ['name' => 'intent', 'in' => 'query', 'schema' => ['type' => 'string']], ['name' => 'timing', 'in' => 'query', 'schema' => ['type' => 'string']], ['name' => 'per_page', 'in' => 'query', 'schema' => ['type' => 'integer']], ['name' => 'page', 'in' => 'query', 'schema' => ['type' => 'integer']]], 'responses' => ['200' => ['description' => 'Paginated risk entries with source attribution']]]],
    ],
    'components' => [
        'schemas' => [
