...
@endforeach
@endif
<p style="margin:20px 0 0;font-size:13px;color:#5D6B7E;">You receive this because your Pro account follows these records. <a href="{{ $manageUrl }}" style="color:#006AAC;">Manage what you follow</a> · <a href="{{ route('changes.index') }}" style="color:#006AAC;">Full change log</a></p>
@endcomponent
