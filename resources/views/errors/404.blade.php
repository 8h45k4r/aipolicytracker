...
<div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 text-center">
    ...
    <h1 class="mt-2 text-2xl sm:text-3xl font-semibold tracking-tight text-slate-900">Page not found</h1>
    <p class="mt-3 text-slate-700">The page may have moved when the site was restructured, or the record may not be published yet.</p>
