...
<div class="container-site py-12 max-w-2xl">
    ...
    <p class="mt-3 meta">We also emailed these links to {{ auth()->user()->email }} (valid 24 hours). Links here are personal and expire in 30 minutes; come back to the <a href="{{ $tool->url() }}">tool page</a> to get fresh ones. Every file states its version, date and that it is informational only.</p>
