...
<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form method="post" action="{{ route('contribute.store') }}" class="mt-8 card-flat p-4 sm:p-6 space-y-4" data-track="submission_submit">
        ...
        @if($errors->any())<div class="rounded-sm border border-rose-200 bg-rose-50 p-3 text-sm text-rose-900" role="alert"><p class="font-medium">Please fix the following:</p><ul class="mt-1 list-disc pl-5">@foreach($errors->all() as $e)<li>{{ $e }}</li>@endforeach</ul></div>@endif
