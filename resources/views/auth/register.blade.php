    ...
    <main class="flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-sm">
            ...
            <form method="post" action="{{ route('register') }}" class="mt-6 space-y-4">
                ...
                <div><label for="organization_name" class="label">Organisation <span class="text-brand-muted font-normal">(optional)</span></label><input id="organization_name" name="organization_name" value="{{ old('organization_name') }}" autocomplete="organization" class="input"></div>
